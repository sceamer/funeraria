...
public class FunerariaApp {

    private static final Logger log = LoggerFactory.getLogger(FunerariaApp.class);

    private final Environment env;

    public FunerariaApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes funeraria.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(FunerariaApp.class);
